...
//        long expireTime = 1000 *  PortalConfig.getInstance().getCheckCodeExpireTime();
//        if((randomTimestamp + expireTime) < now ){
//            throw new CheckCodeExpiredException();
//             //throw new CheckCodeExpiredException("校验码必须在" + expireTime + "秒内输入");
//        }
        return randomString;
    }
    ...
    public static boolean check(HttpSession session, String checkCode){
        ...
        long now = System.currentTimeMillis();
//        long expireTime = 1000 *  PortalConfig.getInstance().getCheckCodeExpireTime();
//        System.out.println("randomTimestamp="+ randomTimestamp +", expireTime=" + expireTime);
